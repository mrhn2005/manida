                ...
                <div class="basic-details">
                    <div class="row clearfix">
                        <div class="image-column col-md-4 col-sm-5 col-xs-12">
                            <figure class="image-box"><a href="{{ Voyager::image($product->single_image())}}" class="lightbox-image" title="{{$product->getTranslatedAttribute('title')}}">
                                <img src="{{ Voyager::image($product->single_image())}}" alt="{{$product->getTranslatedAttribute('title')}}"></a></figure>
                        </div>
                        <div class="info-column col-md-8 col-sm-7 col-xs-12">
                            <div class="details-header">
                                ...
                                <div class="item-price"> ${{$product->getTranslatedAttribute('price')}}</div>
                            </div>
                            
                            <div class="text"> {{$product->getTranslatedAttribute('excerpt')}} </div>
                            <!--<div class="availablity">Available: 1 items Left in Stock</div>-->
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="content-column col-lg-9 col-md-8 col-sm-8 col-xs-12">
                                ...
                                <div class="tabs-container tabs-content">
                                    ...
                                    <!--                    <label>Rating </label>-->
                                    <!--                    <div class="rating">-->
                                    <!--                        <a href="shop-single.html#" class="rate-box" title="1 Out of 5"><span class="fa fa-star"></span></a>-->
                                    <!--                        <a href="shop-single.html#" class="rate-box" title="2 Out of 5"><span class="fa fa-star"></span> <span class="fa fa-star"></span></a>-->
                                    <!--                        <a href="shop-single.html#" class="rate-box" title="3 Out of 5"><span class="fa fa-star"></span> <span class="fa fa-star"> </span> <span class="fa fa-star"></span></a>-->
                                    <!--                        <a href="shop-single.html#" class="rate-box" title="4 Out of 5"><span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span></a>-->
                                    <!--                        <a href="shop-single.html#" class="rate-box" title="5 Out of 5"><span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span></a>-->
                                    <!--                    </div>-->
                                    <!--                </div>-->
